...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0  md:py-[130px] justify-start flex-shrink-0 [perspective:800px] transform md:scale-1 lg:scale-100  scale-[0.6] "
    >
      <motion.h2
        style={{
      ...
      <div className="h-[22rem] w-[32rem] bg-neutral-900 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {badge && <div className="absolute bottom-4 left-4"> <Image src={logo} alt="logo" width={30} height={30}/></div>}
      </div>
    </div>
  );
};
      ...
      >
        ...
        >
          <span className="text-white">
            <Image src={`/logonav.png`} alt="navlogo" width={100} height={100}/>
          </span>
        </div>
      </div>
      <motion.div
