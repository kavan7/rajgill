 ...
 * - Clean, accessible layout with graceful loading & error states
 * - Uniform card sizes, image aspect ratio, and subtle interactions
 * - Uses Next/Image for performance; falls back to placeholder if missing
 */
