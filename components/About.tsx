...
Currently, Shahin is further enhancing her expertise by pursuing a Post-Baccalaureate Diploma in Disaster Management from the Justice Institute of British Columbia. Her unique combination of legal acumen and disaster management knowledge equips her to address complex challenges in legal and emergency contexts with confidence and precision.
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
       Kavan is a Grade 12 Student from Toronto, Ontario. At Raj Gill Law Corporation, Kavan is driven by a deep passion for the law and an unwavering aspiration to become a lawyer. His commitment to understanding complex legal matters and dedication to applying his own experience in tech is a valuable asset to the form. Kavan's enthusiasm for the legal profession is evident in his approach to tackling challenges and delivering insightful legal solutions, all while aspiring to contribute meaningfully to the success of Raj Gill Law Corporation.
        </p>
      );
    },
  },
